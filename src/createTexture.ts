 ...
 * @param src 
 */
export function createScalarTexture(gl: any, textureID: number, width: number, height: number, src: any) {
 ...
 * @param src 
 */
export function createVec2Texture(gl: any, textureID: number, width: number, height: number, src: any) {
    return createTexture(gl, textureID, {
 ...
 * @param src 
 */
export function createVec3Texture(gl: any, textureID: number, width: number, height: number, src: any) {
    return createTexture(gl, textureID, {
